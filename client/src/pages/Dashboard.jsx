            ...
            <div className="mt-10">
              <div className="block sm:hidden">
                <div className="flex flex-col items-start space-y-4">
                  ...
                  <Link to="https://publicmlwebapp-tsxyatfxcmdncsaonr9vxs.streamlit.app/"
                    className="text-white text-lg font-medium"
                  >
                    Disease Prediction
                  </Link>
              ...
              <div className="hidden sm:block">
                <div className="border-b border-gray-200">
                  <nav className="-mb-px flex" aria-label="Tabs">
                    ...
                    <Link to='/recipe'
                      className="whitespace-nowrap ml-8 py-4 px-1 border-b-2 border-transparent font-medium text-sm text-white hover:text-gray-300 hover:border-gray-300 transition duration-150 ease-in-out"
                    >
                      Recipes
                    </Link>
                    <Link to="https://publicmlwebapp-tsxyatfxcmdncsaonr9vxs.streamlit.app/"
